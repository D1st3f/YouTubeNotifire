...
yt_config = {
    "Youtube Link": [
        "https://www.youtube.com/channel/UCTZKGpLLemdjKZxV6owQPrg/videos",  # soloWay gaming
...
ds_config = {
    "DISCORD_CHANEL": [["YOUR WEBHOOK HERE", "SendEveryChannelVideo"]  # DISCORD WEBHOOK LINK AND FILTER
                       ]
}
...
tg_config = {
    ...
    "TELEGRAM_CHANEL": [
        ["INSERT YOUR CHANEL HERE", "OLDboi", "Tony Persitski",
         "soloWay gaming", "STERNENKO", "Телебачення Торонто",
         "Geek Journal", "ROZETKA", "AZOV media", "Kolegi Studio!",
         "PlayStation Україна", "MrBeast", "Канал Горобина",
         "MARKUS", "ТА"]
    ]  # TELEGRAM TOKEN, CHANEL ID AND FILTER
}
...
send_config = {
    ...
    "Telegram_debug_channel": 00000000  # place here your telegram id
}
